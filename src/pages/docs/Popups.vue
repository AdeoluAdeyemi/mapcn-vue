...
import { ref } from 'vue'
import { Map, MapPopup } from '@/components/map'
...
<template>
  <Map :center="[-0.1276, 51.5074]" :zoom="12">
    ...
    >
      ...
      <p>This is a standalone popup component.</p>
    </MapPopup>
  </Map>
</template>`
</script>
  ...
  <div class="flex">
    ...
    <div class="container py-12 flex-1">
      <div class="mx-auto max-w-5xl">
        <div class="space-y-2">
          <h1 class="text-3xl font-semibold tracking-tight text-foreground">Popups</h1>
          <p class="text-base text-muted-foreground leading-relaxed">Display standalone popups on your map at specific coordinates.</p>
        </div>
              ...
              <div class="relative h-[500px] w-full overflow-hidden">
                <Map :center="[-0.1276, 51.5074]" :zoom="12">
                  <MapPopup
                    ...
                    @close="showPopup = false"
                  >
                    <h3 class="font-semibold mb-2">Welcome to London!</h3>
                    <p class="text-sm text-muted-foreground">
                      This is a standalone popup component.
                    </p>
                  </MapPopup>
                </Map>
              </div>
        ...
        <div class="flex items-center justify-between gap-4 mt-14 pt-8 border-t">
          <router-link to="/docs/markers" class="group flex flex-col items-start gap-1.5">
          ...
          <router-link to="/docs/routes" class="group flex flex-col items-end gap-1.5">
            <span class="text-xs text-muted-foreground">Next</span>
            <span class="text-sm font-medium group-hover:underline underline-offset-4">Routes</span>
          </router-link>
        </div>
      </div>
    </div>
